...
#         attachmentPath = f"{appsetting.urlBKFAuth}{pathRootImgSurvey}{picture}"
...
#             </p>
#             <a href="{appsetting.urlBKFAuth}change-password?v={Encrypt(value)}" style="display: block;margin: 50px auto;width: 150px;height:40px;color:#ffffff;font-size:14px;line-height:40px;text-align:center;text-decoration:none;background-color:#00a2cf;border-radius:20px;">Reset Password</a>
...
#             <a href="{appsetting.urlBKFAuth}change-password?v={Encrypt(value)}" style="display: block;margin: 50px auto;width: 150px;height:40px;color:#ffffff;font-size:14px;line-height:40px;text-align:center;text-decoration:none;background-color:#00a2cf;border-radius:20px;">Change Password</a>
#             <p style="margin: 0; padding-top: 20px; font-family: 'Sarabun', sans-serif; font-size: 14px; line-height: 26px; border-top: 1px solid #595e65; text-align: center;">Address : 801 ถ. กาญจนาภิเษก แขวงประเวศ เขตประเวศ กรุงเทพมหานคร 10250<br>Tel : 02 329 5000</p>
#         </div>
#         """
#     return body
